...
fn main() {
    ...
    let secret: Vec<Color> = generate_random_secret_colors();
...
fn generate_random_secret_colors() -> Vec<Color> {
    ...
    for _ in 0..5 {
        ...
        match random_number {
            ...
            8 => {
                random_colors.push(Color::Lime);
            }
            9 => {
                random_colors.push(Color::Fuchsia)
            }
            _ => {}
        }
    }
...
fn fancy_print_guess(guess: &[Color]) {
    for color in guess {
        match color {
            ...
            Color::Lime => {
                print!("{}", Colour::RGB(158, 253, 56).paint("L "));
            }
            Color::Fuchsia => {
                print!("{}", Colour::RGB(253, 63, 146).paint("F "));
            }
        }
    }
    print!("\n");
